...
int main ( int argc, char ** argv )
{
	...
	char tmp1_contacts [200] = "/tmp/Contacts_16SCD_EPS_Mg_Cl_K_";

	char tmp1_coordinates [200] = "/tmp/Coordinates_16SCD_EPS_Mg_Cl_K_";
	
	char tmp1_energies [200] = "/tmp/Energies_16SCD_EPS_Mg_Cl_K_";
	...
	sprintf ( tmp1_contacts + strlen ( tmp1_contacts ), "D%.3f_E%.3f_d%.3f_T%.3f_cM%.4f_f%.3f_s1%d.dat", ss_D, hs_D, st_D, T, cM_crwd [0], cM_crwd [2], seed );
	
	sprintf ( tmp1_coordinates + strlen ( tmp1_coordinates ), "D%.3f_E%.3f_d%.3f_T%.3f_cM%.4f_f%.3f_s1%d.dat", ss_D, hs_D, st_D, T, cM_crwd [0], cM_crwd [2], seed );

	sprintf ( tmp1_energies + strlen ( tmp1_energies ), "D%.3f_E%.3f_d%.3f_T%.3f_cM%.4f_f%.3f_s1%d.dat", ss_D, hs_D, st_D, T, cM_crwd [0], cM_crwd [2], seed );
	...
	if ( my_rank == 0 ) 
	{
		f1 = fopen ( tmp1_contacts, "a" );

		f2 = fopen ( tmp1_coordinates, "a" );

		f3 = fopen ( tmp1_energies, "a" );
	}

	//////////////////////////////////////////////////////////////

	for (klok = 1; klok < 3000000001; klok++)
	{
		if ( (klok % 1000000) == 0 ) 
		{
			st_energy [ 0 ] = E2_STACK;
			...
			if ( my_rank == 0 )
			{
				...
				if ( klok == 3000000000 )
				{
					sprintf ( syscall, "cp %s Contacts_16SCD_EPS_Mg_Cl_K_D%.3f_E%.3f_d%.3f_T%.3f_cM%.4f_f%.3f_s1%d_%d.dat", tmp1_contacts, ss_D, hs_D, st_D, T, cM_crwd [0], cM_crwd [2], seed, (int) (klok / 5000000) );
		
					system ( syscall );

					//////////////////////////////////////////////////////////////
					
					sprintf ( syscall, "cp %s Coordinates_16SCD_EPS_Mg_Cl_K_D%.3f_E%.3f_d%.3f_T%.3f_cM%.4f_f%.3f_s1%d_%d.dat", tmp1_coordinates, ss_D, hs_D, st_D, T, cM_crwd [0], cM_crwd [2], seed, (int) (klok / 5000000) );
		
					system ( syscall );

					//////////////////////////////////////////////////////////////
					
					sprintf ( syscall, "cp %s Energies_16SCD_EPS_Mg_Cl_K_D%.3f_E%.3f_d%.3f_T%.3f_cM%.4f_f%.3f_s1%d_%d.dat", tmp1_energies, ss_D, hs_D, st_D, T, cM_crwd [0], cM_crwd [2], seed, (int) (klok / 5000000) );
				...
				else if ( (klok % 5000000) == 0 )
				{
					...
					sprintf ( syscall, "rm -f Contacts_16SCD_EPS_Mg_Cl_K_D%.3f_E%.3f_d%.3f_T%.3f_cM%.4f_f%.3f_s1%d_%d.dat &", ss_D, hs_D, st_D, T, cM_crwd [0], cM_crwd [2], seed, (int) (klok / 5000000) - 3 );
		
					system ( syscall );
					
					//////////////////////////////////////////////////////////////

					sprintf ( syscall, "rm -f Coordinates_16SCD_EPS_Mg_Cl_K_D%.3f_E%.3f_d%.3f_T%.3f_cM%.4f_f%.3f_s1%d_%d.dat &", ss_D, hs_D, st_D, T, cM_crwd [0], cM_crwd [2], seed, (int) (klok / 5000000) - 3 );
		
					system ( syscall );

					//////////////////////////////////////////////////////////////
					
					sprintf ( syscall, "rm -f Energies_16SCD_EPS_Mg_Cl_K_D%.3f_E%.3f_d%.3f_T%.3f_cM%.4f_f%.3f_s1%d_%d.dat &", ss_D, hs_D, st_D, T, cM_crwd [0], cM_crwd [2], seed, (int) (klok / 5000000) - 3 );
