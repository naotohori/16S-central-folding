...
# -*- coding: utf-8 -*-
'''
Modified on 2020/04/01 based on dcd_traj_SaltCount_kinetics.py
@author: Naoto Hori
'''
...
import math
import numpy as np
from cafysis.lib_f2py import py_count_bound_total
...
while dcd.has_more_data() :
    ...
    if len(id0_Mg) > 0:
        count_Mg, ntotal_Mg = py_count_bound_total.count_bound_total( data, id0_P, id0_Mg, r_count_Mg)
    ...
    if len(id0_K) > 0:
        count_K, ntotal_K = py_count_bound_total.count_bound_total( data, id0_P, id0_K, r_count_K)
